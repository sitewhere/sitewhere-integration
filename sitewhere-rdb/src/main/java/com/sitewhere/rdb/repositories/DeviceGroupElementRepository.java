...
public interface DeviceGroupElementRepository extends CrudRepository<DeviceGroupElement, UUID>,
	JpaSpecificationExecutor<DeviceGroupElement>, PagingAndSortingRepository<DeviceGroupElement, UUID> {
}
